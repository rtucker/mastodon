...
const en = {
  ...
  "compose_form.placeholder": "I wanna know what you're thinking",
  "compose_form.privacy_disclaimer": "Your private status will be delivered to mentioned users on {domains}. Do you trust {domainsCount, plural, one {that server} other {those servers}}? Post privacy only works on Mastodon instances. If {domains} {domainsCount, plural, one {is not a Mastodon instance} other {are not Mastodon instances}}, there will be no indication that your post is private, and it may be awooed or otherwise made visible to unintended recipients.",
  ...
  "getting_started.local_notice": "Please see the {info} page for more information about this instance, including guidelines and contact information.",
  ...
  "navigation_bar.favourites": "Florps (favourites)",
  "navigation_bar.follow_requests": "Follow requests",
  "navigation_bar.info": "Extended information",
  "navigation_bar.logout": "Logout",
  "navigation_bar.preferences": "Preferences",
  "navigation_bar.public_timeline": "Federated timeline",
  "notification.favourite": "{name} florped your status",
  "notification.follow": "{name} followed you",
  "notification.reblog": "{name} awooed your status",
  ...
  "status.sensitive_warning": "OwO ~ Sensitive content",
  ...
  "upload_progress.label": "Uploading... ^_^",
