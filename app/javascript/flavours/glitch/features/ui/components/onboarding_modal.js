...
const PageSix = ({ admin, domain }) => {
  ...
  return (
    <div className='onboarding-modal__page onboarding-modal__page-six'>
      ...
      {adminSection}
      <p><FormattedMessage id='onboarding.page_six.github' defaultMessage='{domain} runs on Glitchsoc (Vulpine Club remix). Glitchsoc is a friendly {fork} of {Mastodon}. Glitchsoc is fully compatible with all Mastodon apps and instances. Glitchsoc is free open-source software. You can report bugs, request features, or contribute to the code on {github}.' values={{ domain, fork: <a href='https://en.wikipedia.org/wiki/Fork_(software_development)' target='_blank' rel='noopener'>fork</a>, Mastodon: <a href='https://github.com/tootsuite/mastodon' target='_blank' rel='noopener'>Mastodon</a>, github: <a href='https://github.com/vulpineclub/mastodon' target='_blank' rel='noopener'>GitHub</a> }} /></p>
