...
class MediaAttachment < ApplicationRecord
  ...
  validates_attachment_size :file, less_than: IMAGE_LIMIT, unless: :video_or_gifv? || :audio?
  validates_attachment_size :file, less_than: VIDEO_LIMIT, if: :video_or_gifv? || :audio?
