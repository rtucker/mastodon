...
RSpec.describe NotificationMailer, type: :mailer do
  ...
  describe "favourite" do
    ...
    it "renders the headers" do
      expect(mail.subject).to eq("bob licked your post")
      expect(mail.to).to eq([receiver.email])
    end

    it "renders the body" do
      expect(mail.body.encoded).to match("Your post was licked by bob")
  ...
  describe "reblog" do
    ...
    it "renders the headers" do
      expect(mail.subject).to eq("bob awooed your post")
      expect(mail.to).to eq([receiver.email])
    end

    it "renders the body" do
      expect(mail.body.encoded).to match("Your post was awooed by bob")
      expect(mail.body.encoded).to include 'The body of the own status'
    end
  end
